...
import { saveShippingAddressId, saveBillingAddressId } from '@/store/slices/orderSlice';
import { getMyAddresses, saveAddress, deleteAddress } from '@/store/slices/addressSlice';
...
const ShippingScreen = () => {
  ...
  const deleteAddressFuction = (addressId) => {
                    ...
                    <ListGroup.Item variant='flush'>
                      <InputGroup>
                        ...
                        <Col md={2} className='mr-0 pr-0'>
                          <Button type='button' variant='light' onClick={() => deleteAddressFuction(a.addressId)}>
